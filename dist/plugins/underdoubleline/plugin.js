...
;// CONCATENATED MODULE: ./src/plugins/underdoubleline/config.js
/* harmony default export */ const config = ({
    name: 'underdoubleline',
    text: '双下划线',
    icon: 'underdoubleline',
    tooltip: '双下划线',
});

;// CONCATENATED MODULE: ./src/plugins/underdoubleline/button.js
...
function registerButton({editor}) {
    function onSetup(api) {
        editor.formatter.register(config.name, {
            inline: 'span',
            styles: {textDecoration: 'underline 1px double'},
        })
...
;// CONCATENATED MODULE: ./src/plugins/underdoubleline/index.js
